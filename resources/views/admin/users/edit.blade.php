            ...
            <form action="{{ route('admin.users.update', $user) }}" method="POST">
                ...
                <div class="mb-6">
                    ...
                    <select name="status" id="status"
                        ...
                        <option value="1" {{ old('status', $user->getRawOriginal('status')) == 1 ? 'selected' : '' }}>Active</option>
                        <option value="0" {{ old('status', $user->getRawOriginal('status')) == 0 ? 'selected' : '' }}>Inactive</option>
                    </select>
                    @if($user->id === auth()->id())
